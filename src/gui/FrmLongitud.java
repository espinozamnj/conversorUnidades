...
public class FrmLongitud extends javax.swing.JInternalFrame {
    Conversor conversor = new Conversor();
    public FrmLongitud() {
        initComponents();
        comboEntrada.setModel(new javax.swing.DefaultComboBoxModel<>(conversor.unidadesLongitud));
        comboSalida.setModel(new javax.swing.DefaultComboBoxModel<>(conversor.unidadesLongitud));
    ...
    private void actualizarSalida() {
        ...
        float valorSalida = conversor.convLongitud(unidadA, unidadB, valorEntrada);
