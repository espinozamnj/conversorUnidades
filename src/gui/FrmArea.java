...
public class FrmArea extends javax.swing.JInternalFrame {
    ...
    public FrmArea() {
        initComponents();
        comboEntrada.setModel(new javax.swing.DefaultComboBoxModel<>(conversor.unidadesArea));
        comboSalida.setModel(new javax.swing.DefaultComboBoxModel<>(conversor.unidadesArea));
        this.title = "Conversor de área";
    }
    ...
    private void actualizarSalida() {
        ...
        float valorSalida = conversor.convArea(unidadA, unidadB, valorEntrada);
