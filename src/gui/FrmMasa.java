...
public class FrmMasa extends javax.swing.JInternalFrame {
    Conversor conversor = new Conversor();
    public FrmMasa() {
        initComponents();
        comboEntrada.setModel(new javax.swing.DefaultComboBoxModel<>(conversor.unidadesMasa));
        comboSalida.setModel(new javax.swing.DefaultComboBoxModel<>(conversor.unidadesMasa));
    ...
    private void actualizarSalida() {
        ...
        float valorSalida = conversor.convMasa(unidadA, unidadB, valorEntrada);
