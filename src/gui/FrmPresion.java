...
public class FrmPresion extends javax.swing.JInternalFrame {
    Conversor conversor = new Conversor();
    public FrmPresion() {
        initComponents();
        comboEntrada.setModel(new javax.swing.DefaultComboBoxModel<>(conversor.unidadesPresion));
        comboSalida.setModel(new javax.swing.DefaultComboBoxModel<>(conversor.unidadesPresion));
        this.title = "Conversor de presión";
    }
    ...
    private void actualizarSalida() {
        ...
        float valorSalida = conversor.convPresion(unidadA, unidadB, valorEntrada);
