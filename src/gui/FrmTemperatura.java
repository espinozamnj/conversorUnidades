...
public class FrmTemperatura extends javax.swing.JInternalFrame {
    Conversor conversor = new Conversor();
    public FrmTemperatura() {
        initComponents();
        comboEntrada.setModel(new javax.swing.DefaultComboBoxModel<>(conversor.unidadesTemperatura));
        comboSalida.setModel(new javax.swing.DefaultComboBoxModel<>(conversor.unidadesTemperatura));
    ...
    private void actualizarSalida() {
        ...
        float valorSalida = conversor.convTemperatura(unidadA, unidadB, valorEntrada);
